...
|------|--------|-------------|--------------|-------------------|---------|
| 1 | Response Time (Avg) | < 2 seconds | 0.0049 sec | [PASS] | Extremely fast ML inference |
| 2 | Response Time (Max) | < 5 seconds | 0.0219 sec | [PASS] | Peak case still well under limit |
| 3 | Throughput (Req/sec) | — | 204.56 req/sec | [PASS] | High throughput |
...
**4.89 milliseconds**, translating to a throughput of **204.6 predictions per second**.
...
---
*Generated by automated_tester.py on 2026-07-02 21:47*
